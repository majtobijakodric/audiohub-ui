...
### Signature Textures
The system background should remain a flat solid surface. Reserve tonal variation for component surfaces only. Page backgrounds should stay plain and texture-free, and primary buttons should use a solid fill rather than a gradient.
...
## 4. Elevation & Depth
In a system with a **tight corner radius**, traditional elevation still feels out of place. We replace "lift" with **Tonal Layering**.
...
### Buttons
* **Primary:** Solid `primary` (#000000) with `on_primary` (#e2e2e2) text. Use a restrained radius around 6px. High contrast is mandatory.
...
### Don’t
* **Don’t** use large or playful rounded corners. Keep radii tight and restrained.
